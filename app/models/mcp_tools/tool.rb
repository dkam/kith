  ...
  class Tool < MCP::Tool
    class << self
      private
        ...
        # When a post went out, or that it has not. A draft has no published_at —
        # that is the whole of being a draft — and its author may read one here,
        # as on its own page.
        def dated(post) = post.published_at&.to_fs(:long) || "draft"
