...
class ProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "the web sees only public posts on a profile, and none of the graph" do
    erin = actors(:erin)
    public_post = erin.posts.create!(title: "In the open", audience: :public, body: "<p>Anyone.</p>", published_at: Time.current)
    private_post = erin.posts.create!(title: "Not in the open", audience: :followers, body: "<p>Only some.</p>", published_at: Time.current)
